...
`P0` · `6 Skills` · `4 Commands` · `Claude Code / Cowork / Codex` · [GitHub](https://github.com/LuckyOneTwoThree/playbook)
...
| 对象 | 角色 | 说明 |
| --- | --- | --- |
| **thesis**（论点） | 北极星 | 必须可被证伪的陈述：目标用户 / 核心问题 / 解法假设 / 为什么现在 / 成功信号 |
...
可靠度上限硬约束：`evidenceLevel` 不得高于来源 `reliability` 的上限。
